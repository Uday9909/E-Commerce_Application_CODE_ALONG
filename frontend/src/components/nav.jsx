                        ...
                        <ul className="flex space-x-8">
                            ...
                            <li>
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        isActive
                                            ? "relative bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold px-4 py-2.5 rounded-lg text-sm transition-all duration-300 shadow-md hover:from-blue-700 hover:to-blue-800 hover:shadow-lg transform hover:-translate-y-0.5"
                                            : "relative text-gray-700 hover:text-blue-600 bg-white hover:bg-blue-50 px-4 py-2.5 rounded-lg text-sm transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5"
                                    }
                                >
                                    Cart
